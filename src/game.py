...
WINDOW_WIDTH = road_gfx.TILE_WIDTH * GRID_WIDTH
WINDOW_HEIGHT = road_gfx.TILE_HEIGHT * GRID_HEIGHT
...
def process_mouse_button_down(window, network):
    ...
    r, c = input.mouse_coord_to_grid_coord(road_gfx.TILE_WIDTH,
                                           road_gfx.TILE_HEIGHT)
...
def display_tile_cursor(window):
    ...
    r, c = input.mouse_coord_to_grid_coord(road_gfx.TILE_WIDTH,
                                           road_gfx.TILE_HEIGHT)
    x = c * road_gfx.TILE_WIDTH
    y = r * road_gfx.TILE_HEIGHT
    rect = pygame.Rect(x, y, road_gfx.TILE_WIDTH,
                       road_gfx.TILE_HEIGHT)
